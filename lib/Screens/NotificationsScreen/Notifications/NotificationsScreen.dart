  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Row(
          children: [
            Center(child: Text('Notifications',style: TextStyle(fontSize: 18,color: AppColors.black,fontFamily: Assets.fontsPoppinsRegular),)),
            Spacer(),
            Container(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            NotificationTile(
              icon: CircleAvatar(
                backgroundImage: AssetImage(Assets.imagesBookingsImage),
                radius: 35,
              ),
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: OutlinedButton(
                        ...
                        child: const Text("Copy URL",style: TextStyle(color:AppColors.primary),),
                      ),
                    ),
            ...
            NotificationTile(
              icon: CircleAvatar(
                ...
                child: Image.asset(Assets.imagesSaleIcon,),
            ...
            NotificationTile(
              icon: CircleAvatar(
                radius: 35,
                backgroundColor: Colors.grey[300],
                child: Image.asset(Assets.imagesDone),
