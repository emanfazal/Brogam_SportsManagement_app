import 'package:brogam_sports_managment/Widgets/PrimaryButton/CustomPrimaryButton.dart';
...
class _EditProfileState extends State<EditProfile> {
  final TextEditingController fullNameController = TextEditingController(text:null);
  final TextEditingController emailController = TextEditingController(text:null);
  final TextEditingController phoneController = TextEditingController(text: null);
          ...
          children: [
            ...
            Stack(
              children: [
                CircleAvatar(
                  radius: 50,
                  backgroundImage: AssetImage(Assets.imagesProfileImage), // Replace with your image asset
                ),
                Positioned(
                  bottom: -20,
                  right: -10,
...
radius: 35,
                      ...
                      child: Image.asset(Assets.imagesEditIcon,width: 70,height: 60,),
                    ),
                  ),
                ),
              ],
...
SizedBox(height: 20,),
            SizedBox(
              ...
              height: MediaQuery.of(context).size.height * 0.06, // Adjust height dynamically
